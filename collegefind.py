...
def collegefind():
    ...
    def clear():
        ...
        e1.delete(0,100)
        f1.delete(0,100)
    s=Label(t,text='COLLEGE FIND',font=40,fg='black',bg='red')
    s.place(x=180,y=50)
    ...
    bt1.place(x=200,y=450,height=40,width=80)
    bt2=Button(t,text='CLEAR',bg='orange',command=clear)
    bt2.place(x=300,y=450,height=40,width=80)
    t.mainloop()