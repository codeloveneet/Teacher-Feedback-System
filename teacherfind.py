...
def teacherfind():
    ...
    def clear():
        ...
        f1.delete(0,100)
        g1.delete(0,100)
    s=Label(t,text='TEACHERS FIND',font=40,fg='black',bg='red')
    s.place(x=200,y=50)
    a=Label(t,text='Teacher id',font=20,bg='green')
    a.place(x=75,y=125)
    a1=ttk.Combobox(t,width=27)
    a1.place(x=250,y=130)
    idlist=fillids()
    a1['values']=idlist
    ...
    bt1.place(x=200,y=500,height=40,width=80)
    bt2=Button(t,text='CLEAR',bg='orange',command=clear)
    bt2.place(x=300,y=500,height=40,width=80)
    t.mainloop()